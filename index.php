...
<html lang="en">
  <head>
    ...
    <meta name="description" content="SKI AREÁL Luisino údolí">
    ...
    <header id="home">
      <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark top">
        <a href="#home" class="navbar-brand logo">
          <h1 class="text-hide">SKI AREÁL Luisino Údolí Krkonoše</h1>
        ...
        <div class="collapse navbar-collapse" id="navbar">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item">
              <a class="nav-link" href="#areal">Areál</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#webcams">Webkamery</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link" href="#rental">Půjčovna</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#school">Škola</a>
            </li>
            <li class="nav-item">
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-12 col-lg-6">
              <p>
                V areálu jsou k dispozici 2 vleky o délkách 500 m a 300 m s obtížností sjezdovek střední a lehká. Tým areálu za pomoci profesionální techniky a umělého zasněžování se postará o ideální podmínky pro lyžování v průběhu celé lyžařské sezóny. Penzion Liberecká Bouda u horní stanice vleku poskytuje ubytovací, wellness a restaurační služby včetně venkovního Skibaru. Parkoviště je u nás zcela zdarma pouhých pár desítek metrů od spodní stanice lyžařského vleku. Od sezóny 2018/19 výuku lyžování a snowboardingu zajišťuje lyžařská škola Mountain Rangers, která se kvalifikovaně postará o začínající i zkušenější lyžaře včetně Vašich ratolestí s celodenním doprovodným programem nebo lyžařskými závody.
              </p>
            </div>
            <div class="col-12 col-lg-6">
              <div id="gallery"></div>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-12 col-md-9 d-none d-md-block">
              <a class="webcam-main" data-name="udoli" data-link="https://www.libereckabouda.cz/kamera/ip-camera-lb-<cam_name>.jpg"><img src="" /></a>
            </div>
          ...
          <div class="col-12">
            <table class="table table-bordered table-hover">
              <tbody>
                ...
                <tr>
                  <td colspan="2">Čipová karta lze kdykoli dobíjet novými body - minimální dobití je 10 bodů.</td>
                </tr>
                <tr>
          ...
          <div class="col-12">
            ...
            <table class="table table-bordered table-hover">
              <tbody>
                ...
                <tr>
                  <td>Odpoledne od 12:30 do 16:00</td><td>280</td>
                </tr>
                <tr>
                  <td>Celodenní</td><td>340</td>
                </tr>
                <tr>
                ...
                <tr>
                  <td colspan="2">K dispozici je kompletní vybavení na SNOWBOARD či LYŽE.</td>
                </tr>
                <tr>
                ...
                <tr>
                  <td colspan="2">
                    <a href="mailto:pujcovna@skiareal-krkonose.cz?subject=Dotaz">pujcovna@skiareal-krkonose.cz</a>
                  </td></tr>
